...
因此等價類計數問題**常常與[組合數](./combinatorics.md)有關**。
...
| 題目 | 重點 |
| --- | --- |
| [ABC455E Unbalanced ABC Substrings](../../problem_solutions/ABC/455/ABC455E.md) | 相差等價 |
| [LeetCode 2033 Minimum Operations to Make a Uni-Value Grid](../../problem_solutions/LeetCode/LeetCode2033.md) | 同餘等價 |
